        ...
        <!-- Form Create/Edit -->
            ...
            <div class="card-header">
                ...
                <form action="" method="POST">
                    <div class="mb-3 row">
                        <label for="judul" class="col-sm-2 ">Judul Tugas Akhir</label>
                        <div class="col-sm-10">
                            <input type="text" class="" id="judul" name="judul" value="<?php echo $judul; ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="id_mahasiswa" class="col-sm-2">Mahasiswa</label>
                        <div class="col-sm-10">
                            <select  name="id_mahasiswa" id="id_mahasiswa">
                                <option>---</option>
                                <?php
                                $query_mahasiswa = mysqli_query($mysqli, "SELECT * FROM mahasiswa") or die(mysqli_error($mysqli));
                    ...
                    <div class="mb-3 row">
                        <label for="id_dosen" class="col-sm-2 ">Dosen Pembimbing</label>
                        <div class="col-sm-10">
                            <select  name="id_dosen" id="id_dosen">
                                <option>---</option>
                                <?php
                                $query_dosen = mysqli_query($mysqli, "SELECT * FROM dosen") or die(mysqli_error($mysqli));
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $query_tugas_akhir = mysqli_query($mysqli, "SELECT tugas_akhir.id, tugas_akhir.judul, mahasiswa.nama AS nama_mahasiswa, dosen.nama AS nama_dosen FROM tugas_akhir INNER JOIN mahasiswa ON tugas_akhir.id_mahasiswa = mahasiswa.id INNER JOIN dosen ON tugas_akhir.id_dosen = dosen.id") or die(mysqli_error($mysqli));
                        $nomor = 1;
                        while ($tugas_akhir = mysqli_fetch_array($query_tugas_akhir)) { 
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    ...
                                    <a href="tugasakhir.php?op=edit&id=<?php echo $id ?>"><button type="button" >Edit</button></a>
                                    <a href="tugasakhir.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button">Delete</button></a>
                                </td>
                            </tr>
                        <?php
                        }
